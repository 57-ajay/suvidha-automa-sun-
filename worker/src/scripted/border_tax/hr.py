...
async def run(
    ...
    if outcome == "pending_popup":
        ...
        print(f"[hr.phase3] pending-tx popup detected; attempting auto-clear")
        ...
        print(f"[hr.phase3] pending tx cleared; restarting phases 1+2")
    ...
    if is_manual:
        ...
        # record now. The "fill if empty" blocks below then no-op because
        # every field is already populated (HR has a Distance field, set here
        # too). Validity dates are plain type="date" on this step.
