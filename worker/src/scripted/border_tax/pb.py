...
async def run(
    ...
    if outcome == "pending_popup":
        ...
        print(f"[pb.phase3] pending-tx popup detected; attempting auto-clear")
        ...
        print(f"[pb.phase3] pending tx cleared; restarting phases 1+2")
    ...
    if is_manual:
        ...
        # every field is already populated. PB has no Distance field.
